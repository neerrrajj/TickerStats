...
def calculate_statistics(data, start_date=None, end_date=None):
    ...
    # Green/Red days from previous close - needs previous data
    ...
    # Green/Red days from current day open - doesn't need previous data
    ...
    # Green days from previous close (always positive when they exist)
    ...
    # Red days from previous close (always positive when they exist)
    ...
    # Green days from current open (always positive when they exist)
    ...
    # Red days from current open (always positive when they exist)
